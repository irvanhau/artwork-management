...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * from drafter where id=$id");
    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            <div class="col-md-12 py-3 px-3">
                ...
                <div class="mb-3">
                    <a href="<?php echo BASE_URL2 . "account_edit_pass.php?id=$id"; ?> "><button class="btn btn-primary">Edit Password</button></a>
                    <a href="<?php echo BASE_URL2 . "dashboard.php?id=$id"; ?>" class="text-white text-decoration-none"><button class="btn btn-danger" type="button">Cancel</button></a>
                </div>
            </div>
        </div>
    </div>
