...
$queryProses = mysqli_query($koneksi, "SELECT proses.* from proses join job_order on proses.job_id=job_order.jo_number where proses.job_id=$job_id");
$queryComment = mysqli_query($koneksi, "SELECT corrector_comment.* from corrector_comment join job_order on corrector_comment.jo_number=job_order.jo_number where corrector_comment.jo_number=$job_id");
            ...
            <div class="col-md-12 py-3 px-3">
                <div class="row">
                    ...
                    <div class="col py-4">
                        ...
                        <a href="<?php echo BASE_URL2 . "dashboard.php?id=$id"; ?>"><button class="btn btn-warning" type="button">Back</button></a>
                    </div>
                </div>
                ...
                <?php
                if ($rowProses['process_id'] == 1) {
                    echo "<form action='" . BASE_URL . "detail_action.php?job_id=$job_id' method='POST' enctype='multipart/form-data'>";
                }
                ?>
                <div class=" col mb-3">
                    ...
                    if ($rowProses['process_id'] == 1) {
                        echo "
                                    <input type='file' class='form-control mb-2' name='artwork_draft'>
                        ...
                        echo "<a href='" . BASE_URL . "download.php?file=$rowDraft[artwork_draft]&name=artwork-draft'><button type='submit' class='btn btn-primary'>Download Attachment</button></a>";
                ...
                <div class="col mb-3">
                    ...
                    if ($rowProses['process_id'] == 3) {
                        ...
                        echo "<a href='" . BASE_URL . "download.php?file=$rowFinal[artwork_final]&name=artwork-final'><button type='submit' class='btn btn-primary'>Download Attachment</button></a>";
                        // echo "<button type='submit' class='btn btn-primary'>Download Artwrok Draft</button>";
                    } else if ($rowProses['process_id'] == 1) {
                ...
                <div class="mb-3">
                    ...
                    if (isset($rowComment)) {
                        ...
                        echo "<textarea class='form-control' id='comment' rows='3' disabled>$rowComment[comment]</textarea>";
                    }
                    ?>
                </div>
                ...
                <div class="mb-3">
                    ...
                    if ($rowProses['process_id'] == 2) {
                        echo "<input type='submit' name='button' value='Submit' class='btn btn-primary' disabled>";
                    } else if ($rowProses['process_id'] == 1) {
                        echo "<input type='submit' name='button' value='Submit' class='btn btn-primary'>";
                    }
                    ?>
                    <a href="<?php echo BASE_URL2 . "dashboard.php?id=$id"; ?>"><button class="btn btn-danger" type="button">Cancel</button></a>
                </div>
                <?php
                if ($rowProses['process_id'] == 1) {
                    echo "</form>";
