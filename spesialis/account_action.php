...
$queryUser = mysqli_query($koneksi, "SELECT * from specialist where id='$id' and password='$old_password'");
...
if (mysqli_num_rows($queryUser) == 0) {
    ...
    if ($new_password === $confirm_new_password) {
        $update_user = "UPDATE specialist set password = '$new_password' where id='$id'";
