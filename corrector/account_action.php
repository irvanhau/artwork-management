...
$queryUser = mysqli_query($koneksi, "SELECT * from corrector where id='$id' and password='$old_password'");
...
if (mysqli_num_rows($queryUser) == 0) {
    ...
    if ($new_password === $confirm_new_password) {
        $update_user = "UPDATE corrector set password = '$new_password' where id='$id'";
